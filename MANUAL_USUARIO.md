...
Tambien limita mejor las esperas de workflows de ComfyUI para que un timeout HTTP alto no se convierta automaticamente en una espera total de una hora por escena.
